    ...
    <main className="min-h-screen bg-slate-950 flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <h1 className="text-xl font-bold text-white">Şagird Paneli</h1>
          <p className="text-slate-400 text-sm mt-1">
            Müəllim tərəfindən verilən məlumatlarla daxil olun
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-slate-900 rounded-2xl p-6 space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full bg-slate-800 text-white rounded-lg px-4 py-2.5 text-sm
        ...
        <p className="text-center text-slate-600 text-xs mt-6">
          Giriş məlumatlarınızı müəllimdən alın
        </p>
      </div>
    </main>
  );
